...
%%
\begin{align}
& F^{i}_{t+1}(X',t) = X^i_{t}(W^i_{t+1}-W^i_{t})\,.
\end{align}
%%
...
%%
\begin{align}
& F^{i}_{t+1}(X',t) = B^i_{t+1}({H_i})-B^i_{t}({H_i})\,.
\end{align}
%%
...
%%
\begin{align}
& F^{i}_{t+1}(X',t) = g^i_{t+1}(X', W^i_{t+1}-W^i_t, \dots) \,,
\end{align}
%%
...
%%
\begin{align}
& F^{i}_{t+1}(X',t) = N^i_{t+1}({\lambda_i})-N^i_{t}({\lambda_i})\,,
\end{align}
%%
...
%%
\begin{align}
& F^{i}_{t+1}(X',t) = N^i_{t+1}({\lambda^i_{t+1}})-N^i_{t}({\lambda^i_t}) \,,
\end{align}
%%
...
%%
\begin{align}
& F^{i}_{t+1}(X',t) = N^i_{t+1}({\Lambda^i_{t+1}})-N^i_{t}({\Lambda^i_{t}}) \,,
\end{align}
%%
...
%%
\begin{align}
& F^{i}_{t+1}(X',t) = N^i_{t+1}[{\cal I}^i_{t+1}(N', \dots)]-N^i_{t}[{\cal I}^i_{t}(N'', \dots)]\,,
\end{align}
%%
