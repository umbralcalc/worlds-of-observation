...
\emph{Diffusing ideas} records a journey of research exploration and software development over several years. It's primarily an expression of interrelated ideas around the statistical inference and automated control of stochastic phenomena in general. However, in order to manifest these ideas into reality, this project has also involved designing and building a lot of new open-source scientific software written in the \href{https://www.python.org/}{Python} and \href{https://go.dev/}{Go} progamming languages as well. The main motivation behind developing these computational elements is to form a nice foundation from which anyone can build loads of new applications, and the hope is that an additional benefit should be that they make scientific research and discovery of new phenomena a more efficient experience for the scientist. 
