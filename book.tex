...
\includegraphics*[width=7cm]{images/page-design-1.png}}

\input{building_a_generalised_simulator/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-2.png}}

\input{simulating_a_financial_market/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-3.png}}

\input{quantum_jumps_on_generic_networks/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-4.png}
\\{\sffamily Part 2}}

\input{empirical_probabilistic_filtering/chapter.tex}

\part*{
\includegraphics*[width=5cm]{images/page-design-5.png}}

\input{generalised_map_inference/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-6.png}}

\input{inferring_2d_spatial_dynamics/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-7.png}}

\input{learning_from_ants_on_curved_surfaces/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-8.png}}

\input{a_world_of_hydrodynamic_ensembles/chapter.tex}

\part*{{\sffamily Part 3}\\
\includegraphics*[width=7cm]{images/page-design-9.png}}

\input{interacting_with_systems_in_general/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-10.png}}

\input{angling_for_freshwater_fish/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-11.png}}

\input{managing_a_rugby_match/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-12.png}}

\input{influencing_house_prices/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-13.png}
\\{\sffamily Part 4}}

\input{optimising_actions_for_control_objectives/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-14.png}}

\input{resource_allocation_for_epidemics/chapter.tex}

\part*{
\includegraphics*[width=7cm]{images/page-design-15.png}}
