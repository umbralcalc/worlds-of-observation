...
\input{simulating_a_financial_market/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-3.png}}

\input{quantum_jumps_on_generic_networks/chapter.tex}

\part*{{\sffamily Part 2. {\color{gray75} How do we then learn/identify the answer to Part 1 from real-world data?}}
\includegraphics*[width=14cm]{images/page-design-4.png}}

\input{empirical_dynamical_emulators/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-5.png}}

\input{inferring_dynamical_2d_maps/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-6.png}}

\input{learning_from_ants_on_curved_surfaces/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-7.png}}

\input{a_world_of_hydrodynamic_ensembles/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-8.png}}

\input{generalised_statistical_inference_tools/chapter.tex}

\part*{{\sffamily Part 3. {\color{gray75} How do we simulate a general set of control policies to interact with the answer to {\bfseries\sffamily Part 1}?}}
\includegraphics*[width=14cm]{images/page-design-9.png}}

\input{interacting_with_systems_in_general/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-10.png}}

\input{angling_for_freshwater_fish/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-11.png}}

\input{managing_a_rugby_match/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-12.png}}

\input{influencing_house_prices/chapter.tex}

\part*{{\sffamily Part 4. {\color{gray75} How do we then optimise the answer to {\bfseries\sffamily Part 3} to achieve a specified control objective?}}
\includegraphics*[width=14cm]{images/page-design-13.png}}

\input{optimising_actions_for_control_objectives/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-14.png}}

\input{resource_allocation_for_epidemics/chapter.tex}

\part*{
\includegraphics*[width=14cm]{images/page-design-15.png}}
