...
\begin{itemize}
\item{Spatially-distributed populations - epidemiology, ecosystems}
\item{Correlated state networks - brain or traffic networks}
\item{Event-based process graphs - logistics pipelines, sports matches}
\item{Multi-agent interactions - markets and social systems}
\item{Maybe one more example? Sequential design?}
\end{itemize}}
