...
\part*{{\sffamily Part 1. How do we simulate a general set of stochastic phenomena?}}
...
\part*{{\sffamily Part 2. How do we then learn/identify the answer to Part 1 from real-world data?}}
...
\part*{{\sffamily Part 3. How do we simulate a general set of control policies to interact with the answer to Part 1?}}
...
\part*{{\sffamily Part 4. How do we then optimise the answer to Part 3 to achieve a specified control objective?}}
