...
// generate a new Wiener process sample for a state element
func NewWienerProcessSample(timeStepNumber TimeStepNumber) StateElement {
...
func IterationFormula(
    ...
    newestStateVector := make(StateVector, 0)
    // note that we don't care about the history in this case = Markovian
    for _ = range stateVector {
        sample := NewWienerProcessSample(timeStepNumber)
        newestStateVector = append(newestStateVector, sample)
    }
    return newestStateVector
}
\end{lstlisting}
