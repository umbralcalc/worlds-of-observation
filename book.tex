...
%%
\begin{align}
p_{\sf t}(X_{{\sf t}'}, X_{{\sf t}''}\vert X_{{\sf t}+1},{\sf t}+1) &= p_{\sf t}(X_{{\sf t}'}\vert X_{{\sf t}+1},{\sf t}+1)p_{\sf t}(X_{{\sf t}'}\vert X_{{\sf t}''},{\sf t}'')p_{\sf t}(X_{{\sf t}''}\vert X_{{\sf t}+1},{\sf t}+1) \\
