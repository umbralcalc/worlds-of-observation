...
So I've proposed a computational formalism and done a bit of analysis on it to demonstrate that it can cope with a variety of different stochastic phenomena. Now I think we're ready to summarise what we want the stochadex software package to be able to do. 

\begin{itemize}
\item{Directly configurable for a range of known examples and also extensible such that the configurations are continually increasing in applicability.}
\end{itemize}
...
\section{\sffamily Statistical performance analysis}

\begin{itemize}
\item{Erlang distribution-based statistical performance analysis.}
\end{itemize}
