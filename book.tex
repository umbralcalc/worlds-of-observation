...
\end{align}
%%
If we were to now insert these probabilities into Eq.~(\ref{eq:master-x-cont-kramers-moyal}), after some further mathematical manipulations we would eventually find that $\alpha^{i}_1(X_{{\sf t}+1}) = 0$ and
%%
\begin{align}
\alpha^{ij}_2(X_{{\sf t}+1}) &= \,,
\end{align}
%%
