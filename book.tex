...
Welcome to \emph{Diffusing ideas}: a book devoted to the wondrous world of stochastic phenomena. Here, we will build tools for discovery and influence, play with mathematical toys and explore what software designs work well to answer various research questions. No quest would be complete without a map, so in this introductory section I will outline some of the key milestones that this book will aim to reach as you read through it, and my motivations for setting them.
