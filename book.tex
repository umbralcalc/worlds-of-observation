...
%%
\begin{align}
&p_{{\sf t}+1}(X_{{\sf t}+1}\vert X',{\sf t}) = \prod_{{\sf t}'=0}^{\sf t} (2\pi )^{-\frac{d}{2}}\vert K(\theta, X_{{\sf t}+1}, X_{{\sf t}'})\vert^{-\frac{1}{2}}{\rm exp}\Bigg[ -\frac{1}{2}\sum_{i=1}^d\sum_{j=1}^d\frac{f^i(X_{{\sf t}+1})f^j(X_{{\sf t}'})}{K^{ij}(\theta, X_{{\sf t}+1}, X_{{\sf t}'})}\Bigg] \,.
\end{align}
%%
