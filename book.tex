...
This example was just for illustration rather than using the Gaussian process for what it's intended for. However, it did highlight that the Kramers-Moyal-like expansion we wrote above is probably most usefully employed in situations with Markovian phenomena (where the expansion is more usually applied).
