...
\end{align}
%%
Note that I write $\vert K(\theta, {\sf t}+1, {\sf t}') \vert$ meaning the determinant of the matrix. \textcolor{red}{Double-check the probability current is zero and introduce the idea of probability currents.}
