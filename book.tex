...
\item{Correlated state networks - brain, power, water or traffic networks}
\item{Processing pipelines - logistics, data processing}
\item{Multi-agent narkets - financial, betting, housing, resource exchanges}
\end{itemize}}
...
\input{correlated_state_networks/chapter.tex}

\input{processing_pipelines/chapter.tex}

\input{multi_agent_markets/chapter.tex}
