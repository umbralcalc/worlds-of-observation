...
{\bfseries\sffamily Concept.} Leveraging the formalism that we developed in the previous chapter to be able to empirically emulate real-world data in a probabilistic way. This technique should enable a researcher to model complex trends in the data dynamically very well; at the cost of making the abstract interpretation of the model less immediately comprehensible in comparison to the statistical inference models of the next chapter. As our generalised framework applies to a wide variety stochastic phenomena, our emulator will be applicable to a great breadth of data modeling problems as well. In this chapter, we will also explore some examples which illustrate how our empirical emulator should be applied in practice and then follow this up with how the code is designed and implemented within the stochadex. For the mathematically-inclined, this chapter will take a detailed look at how our formalism can be extended to focus on probabilistic dynamical process emulation. For the programmers, we will be creating some new modules in the stochadex public Git repository: \href{https://github.com/umbralcalc/stochadex}{https://github.com/umbralcalc/stochadex}.
