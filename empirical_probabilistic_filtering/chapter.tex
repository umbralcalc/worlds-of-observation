...
\textcolor{red}{I think there's something potentially generalised here that would be worth exploring by using the adjoint master equation to figure out gradients? }
...
\item{then talk about the optimiser! starting with non-gradient-based: the two packages that are supported out of the box are gonum and gago (still need to do gago --- see here: github.com/maxhalford/eaopt) }
