...
%%
\begin{align}
\ln {\cal L}_{{\sf t}+1}(z) = \ln P_{{\sf t}+1}[y;M_{{\sf t}+1}(z),C_{{\sf t}+1}(z),\dots ] + \ln P_{{\sf t}}[y';M_{{\sf t}}(z),C_{{\sf t}}(z),\dots ] + \dots \,, \label{eq:log-likelihood-filter}
\end{align}
%%
...
%%
\begin{align}
\frac{\partial}{\partial z^i}\ln {\cal L}_{{\sf t}+1}(z) &= \frac{\partial M_{{\sf t}+1}}{\partial z^i}\frac{\partial}{\partial M_{{\sf t}+1}}\ln P_{{\sf t}+1}[y;M_{{\sf t}+1}(z),C_{{\sf t}+1}(z),\dots ] \nonumber \\ 
