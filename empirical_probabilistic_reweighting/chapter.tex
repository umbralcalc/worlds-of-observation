...
\textcolor{red}{Need to introduce and create an offline AND online version of this algorithm: `Online' learning algorithms must update continuously as data is given to them, whereas `offline' learning algorithms can train with the whole dataset provided upfront. Point out how $z$ can still be considered constant in time because this learning approach is just dynamically changing the model within an ensemble of possible models.}
