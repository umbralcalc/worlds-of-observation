...
\textcolor{red}{Note that these reweightings could be also predicted by a neural network --- investigate if this would be another good thing to introduce here. Check that the compression into statistics of a data-linking distribution is desirable and common for generative models. The other benefit would be acquiring gradients to train this quickly and retrain it dynamically. }

\textcolor{red}{Introduce libtorch integration here in order to use neural networks!}
