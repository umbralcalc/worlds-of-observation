...
%%% LOOK HERE....
%% Use this article to handle this bit: https://medium.com/hal24k-techblog/a-guide-to-generating-probability-distributions-with-neural-networks-ffc4efacd6a4
\textcolor{red}{Introduce TensorFlow Keras integration here in order to use neural networks!}
