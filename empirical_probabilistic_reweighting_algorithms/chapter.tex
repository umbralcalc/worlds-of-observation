\chapter{\sffamily Empirical probabilistic reweighting algorithms}
...
\textcolor{red}{
    \begin{itemize}
    \item{Need to finish the descriptions in this section to move onto the next...} 
    \end{itemize}
}
...
\textcolor{red}{Take a step back and consider all the use-cases for the learnadex:
\begin{itemize}
...
\end{itemize}
\item{Separate thread context forward projection stepper}
\end{itemize}}
