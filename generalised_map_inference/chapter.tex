...
%%
\begin{align}
{\cal P}^{n+1}_{{\sf t}+1}(z \vert y, y', \dots) = \frac{1}{n}\sum_{n'=0}^n\int_{\upsilon} \,{\rm d}z' \, P^{(n+1)n'}(z\vert z')\, {\cal P}^{n'}_{{\sf t}+1}(z' \vert y, y', \dots) \label{eq:posterior-process} \,,
\end{align}
%%
