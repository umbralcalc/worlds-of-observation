...
%%
\begin{align}
{\cal P}^{n+1}_{{\sf t}+1}(x\vert z, y, y', \dots) &= \frac{1}{{\sf t}}\sum_{{\sf t}'=0}^{{\sf t}}\int_{\omega_{{\sf t}'}} \,{\rm d}x' \, P_{({\sf t}+1){\sf t}'}(x\vert x',z)\, {\cal P}^{n+1}_{{\sf t}'}(x'\vert z, y, y', \dots) \\
{\cal P}^{n+1}_{{\sf t}+1}(z \vert x, y) &= \frac{1}{n}\sum_{n'=0}^n\int_{\upsilon_{n'}} \,{\rm d}z' \, P^{(n+1)n'}(z\vert z')\, {\cal P}^{n'}_{{\sf t}+1}(z'\vert x, y) \label{eq:posterior-process} \,,
\end{align}
%%
