...
X^2_{{\sf t}} &= \text{Player 1 Attributes ({\sf Home Team})} \\
&\dots \nonumber \\
X^{32}_{{\sf t}} &= \text{Player 15 Attributes ({\sf Away Team})}\,.
\end{align}
%%
...
\begin{itemize}
\item{Define the spatial distance model association to player attributes...}
\end{itemize}
