...
\textcolor{red}{Need to figure out what models to use for each case from here...}

There's also an angular component to this motion which is associated to the direction that the kicker is orientating their kick. Let's begin by defining the chosen angle $\theta$ of the attacking team player who is kicking (where straight ahead is defined as $\theta = 0$) such that
%%
\begin{align}
