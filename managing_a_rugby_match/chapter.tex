...
\begin{figure}[h]
\includegraphics[width=14cm]{images/chapter-12-trywizard-event-graph.drawio.png}
...
\begin{figure}[h]
\includegraphics[width=15cm]{images/chapter-12-rugby-player-abilities.drawio.png}
