...
{\bfseries\sffamily Concept.} Defining an archetype simulation environment for spatial density fields. In our classification scheme, this archetype is defined by a highly-structured, bidirectional state partition graph topology and would make sense for simulations of spatial epidemiological processes, ecosystems and weather.
